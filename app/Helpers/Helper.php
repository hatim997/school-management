...
class Helper
{
    ...
    {
        return CompanySetting::first()->light_logo ?? asset('uploads/company/logo-default.png');
    }
    public static function getLogoDark()
    {
        return CompanySetting::first()->dark_logo ?? asset('uploads/company/logo-default.png');
    }
    public static function getFavicon()
    {
        return CompanySetting::first()->favicon ?? asset('uploads/company/logo-default.png');
    }
