...
@section('content')
    ...
    <h5 class="mb-1">Welcome to {{ \App\Helpers\Helper::getCompanyName() }}! 👋</h5>
    ...
    <form id="formLogin" class="mb-6" action="{{ route('login.attempt') }}" method="POST">
        ...
        <div class="mb-6">
            <label for="email_username" class="form-label">{{ __('Email/Username') }}</label><span class="text-danger">*</span>
            <input type="text" class="form-control @error('email_username') is-invalid @enderror" id="email_username"
                name="email_username" placeholder="{{ __('Enter your email or username') }}" autofocus required />
            @error('email_username')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
