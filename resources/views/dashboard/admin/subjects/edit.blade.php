    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.admin.subjects.update', $subject->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row p-5">
                        <h3>{{ __('Edit Subject') }}</h3>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('code') is-invalid @enderror" type="text" id="code"
                                name="code" required placeholder="{{ __('Enter code') }}" value="{{ old('code', $subject->code) }}" />
                            @error('code')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('price') is-invalid @enderror" type="number" step="any" id="price"
                                name="price" required placeholder="{{ __('Enter price') }}" value="{{ old('price', $subject->price) }}" />
                            @error('price')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('duration') is-invalid @enderror" type="number" id="duration"
                                name="duration" required placeholder="{{ __('Enter duration') }}" value="{{ old('duration', $subject->duration) }}" />
                            @error('duration')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('rating') is-invalid @enderror" type="number" id="rating"
                                name="rating" min="0" max="5" required placeholder="{{ __('Enter rating') }}" value="{{ old('rating', $subject->rating) }}" />
                            @error('rating')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('total_enrolled') is-invalid @enderror" type="number" id="total_enrolled"
                                name="total_enrolled" min="0" required placeholder="{{ __('Enter total enrolled') }}" value="{{ old('total_enrolled', $subject->total_enrolled) }}" />
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            @if (isset($subject->image))
                                <img src="{{ asset($subject->image) }}" alt="{{ $subject->name }}" height="50px" width="50px">
                            @endif
                        </div>
                        <div class="mb-4 col-md-12">
                            ...
                            <input class="form-control @error('short_description') is-invalid @enderror" type="text" id="short_description"
                                name="short_description" placeholder="{{ __('Enter short description') }}" required value="{{ old('short_description', $subject->short_description) }}" />
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                placeholder="{{ __('Enter description') }}" cols="30" rows="10">{{ old('description',$subject->description) }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-3">{{ __('Update Subject') }}</button>
                    </div>
                </form>
            </div>
            <!-- /Account -->
